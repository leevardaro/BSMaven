...
class IPhone implements Runnable {
	public void run() {
		...
		capsHashtable.put("build", AppTest.buildName);
		capsHashtable.put("name", "IPhone");
		capsHashtable.put("browserstack.local", AppTest.browserstackLocal);
		capsHashtable.put("browserstack.localIdentifier", AppTest.browserstackLocalIdentifier);
